...
`;
 ...
 return request("https://i.imgur.com/qTTmhRn.jpeg").pipe(fs.createWriteStream(imgPath)).on("close", () => callback());
 }
 ...
 return request("https://i.imgur.com/AwUV3RJ.jpeg").pipe(fs.createWriteStream(imgPath)).on("close", () => callback());
};