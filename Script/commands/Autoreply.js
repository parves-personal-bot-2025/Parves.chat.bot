...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস পারভেস রে হাঙ্গা করো😶👻😘",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ md parves☜\nFacebook: https://www.facebook.com/profile.php?id=100009380400402\nWhatsApp: +88018xxxxxxxxxx",
    "admin": "He is 𝐌𝐃 𝐏𝐀𝐑𝐕𝐄𝐒 তাকে সবাই Cyber Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস পারভেস রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস পারভেস এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "by": "কিরে তুই কই যাস কোন মেয়ের সাথে চিপায় যাবি..!🌚🌶️",
    "ami parves": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝐏𝐀𝐑𝐕𝐄𝐒 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss পারভেস এর ইনবক্সে গুতা দিন 😘",
